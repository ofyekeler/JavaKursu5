...
public class OkulMain {
    ...
    // 5- Oluşturuken her öğrenciye, Lise ve İlkokul class larında ayrı ayrı tanımlanmış sayaçtan no veriniz.
...
io1 = Ogrenci{id=1, isim='zeynep bayrak', tipi='ILK'}Satranç
*/
}
